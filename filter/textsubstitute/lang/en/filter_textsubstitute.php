...
$string['filtername'] = 'Text substitute filter';
...
$string['searchterm_desc'] = 'The old term to replace.';
$string['substituteterm'] = 'Substitute term';
$string['substituteterm_desc'] = 'The new term to substitute the old one with.';